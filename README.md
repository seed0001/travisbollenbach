...
- **Blue pill → `/storefront`** — the professional portfolio: a project gallery of 88 GitHub repos in twelve categories, plus a spotlight on what's actually shipping tagged releases, staged as a 3D boulevard of walkable panels.
