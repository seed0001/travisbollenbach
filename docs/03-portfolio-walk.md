...
13. **The photo** — Travis and his dog ("the one who approves every release"). Press **E** to see it full-screen.

## What you can do

- **Walk and read** — the standard controls (WASD/arrows + mouse, or touch thumbs; **E** at a panel opens its subpage, which pauses movement and frees the cursor; **Esc** closes it).
