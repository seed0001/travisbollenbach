...
- **Blue pill → [The Portfolio Walk](03-portfolio-walk.md)** (`/storefront` — a legacy route name; nothing is for sale) — the professional side: a **project gallery**. Twelve panels along a 3D boulevard, each a category of Travis's GitHub work — 88 repositories in all — and each opening a list of direct links to the repos, plus a spotlight panel on whatever's actually tagged and shipping releases. There are no products, no services, and no sales pitch; the gallery is a walkable index of the work itself.
...
**The professional half** is a single walkable boulevard: twelve category panels covering 88 GitHub projects — 3D worlds, games, AI companions, agents, frameworks, business apps, and more — a thirteenth panel spotlighting what's actually shipping tagged releases, and a fourteenth panel at the end of the road: the photo of Travis and his dog.
